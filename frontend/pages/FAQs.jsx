...
import NewsLetter from "@/components/NewsLetter"; // Updated import path for Next.js (was "../components/NewsLetter")
      ...
      <div className="mx-auto space-y-4">
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 7 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                We accept Visa, Mastercard, PayPal payment methods, and also we have
